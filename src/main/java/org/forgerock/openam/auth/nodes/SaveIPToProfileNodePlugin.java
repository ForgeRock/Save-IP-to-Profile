 ...
 */
public class SaveIPToProfileNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public SaveIPToProfileNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
